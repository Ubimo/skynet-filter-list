# Historical audit (July 23, 2026)

This is a preserved historical snapshot, not the current source selection.
Some sources were subsequently reintroduced; IPsum currently uses level 2.
See sources.json and the generated AUDIT.md for current truth.
